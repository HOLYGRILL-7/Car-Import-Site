...
const CarDetails = () => {
  ...
  const car = {
    ...
    description:
      "This 2024 Toyota Tacoma TRD Pro is in excellent condition with low mileage. Perfect for both city driving and off-road adventures. Well-maintained with full service history.",
    images: [
